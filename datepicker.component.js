...
var DatePicker = /** @class */ (function () {
    ...
    DatePicker.propDecorators = {
        'settings': [{ type: Input },],
        'dropupHeight': [{ type: Input },],
        'relativeToId': [{ type: Input },],
